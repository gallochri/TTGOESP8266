...
#define OLED_SCL 14
#define OLED_RST  4
U8G2_SSD1306_128X32_UNIVISION_F_SW_I2C u8g2(U8G2_R0, OLED_SCL, OLED_SDA , OLED_RST); // NOLINT
const char *text = "gallochri OTA ";  // scroll this text from right to left



//Necesary to make Arduino Software autodetect OTA device
WiFiServer TelnetServer(8266); // NOLINT
...
void loop() {
  ...
  u8g2.drawStr(0, 28, myIP.c_str());  // write something to the internal memory
